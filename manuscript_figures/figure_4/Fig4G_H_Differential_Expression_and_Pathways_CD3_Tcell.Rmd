...
Revisions: ISG15 renamed to IFN1
...
x <- c("progression_groupRP - progression_groupNP") # <column_name><column_value> column chemistry chemistry, column value 3prime chemistry3prime chemistry3
...
names(keyvals.color)[keyvals.color == colors_volcano[[4]]] <- "IFN1"
...
names(keyvals.shape)[keyvals.shape == 64] <- "IFN1"

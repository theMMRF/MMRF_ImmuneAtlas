...
Computes survival curves for select CD3+ T cell markers (Figures 4L, M, N, O)

Revisions: Added Dysfunctional Signature (updated)
...
# Combine figures 4L, 4M, 4N, and 4O, into one figure (to ensure consistent rendering sizes)
```{r}
legend_surv <- cowplot::get_legend(p_naive_cox)

p_all_sig <- cowplot::plot_grid(p_cyto_cox + NoLegend(), p_naive_cox + NoLegend(), p_exh_cox + NoLegend(), p_dys_cox + NoLegend(), legend_surv, nrow = 1, rel_widths = c(1, 1, 1, 1, 0.2))
